...
void j1App::FinishUpdate()
{
	...
	time_to_wait = (1000 / framerate_cap) - last_frame_ms;
	SDL_Delay(time_to_wait);

	// TODO 3: Measure accurately the amount of time it SDL_Delay actually waits compared to what was expected
	time_waited = ptimer.ReadMs() - last_frame_ms;

	LOG("We waited for %d milliseconds and got back in %.6f", time_to_wait, time_waited);
}
